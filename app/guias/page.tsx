        ...
        <div className="mx-auto max-w-6xl">
          ...
          <section className="mt-6 rounded-[2.25rem] border border-rosa-mexicano/12 bg-peach-fuzz/55 p-8 shadow-[0_28px_80px_rgba(43,30,36,0.08)] sm:p-10">
            <SectionHeading
              ...
              title="Guias para estudiar en Alemania"
              description="Informacion clara y paso a paso para planear tu aplicacion, preparar documentos y organizar tu llegada a Alemania desde Mexico."
            />
          </section>
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-2xl">
                ...
                <h2 className="mt-3 font-display text-3xl font-semibold tracking-tight text-dark-text">
                  Tres guias utiles para comenzar con una base clara
                </h2>
                <p className="mt-3 text-base leading-7 text-dark-text/76">
                  Si apenas estas armando tu plan, estas lecturas te ayudan a
              ...
              <p className="rounded-full bg-white/75 px-4 py-2 text-sm font-medium text-dark-text">
                Seleccion recomendada para estudiantes que van empezando
              </p>
            </div>
